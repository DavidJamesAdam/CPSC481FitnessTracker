...
import WorkoutListLogging from "../components/WorkoutListLogging";
...
`;
const LoggingWorkoutListRoot = styled.div`
  position: relative;
  background-color: var(--surface);
  width: 100%;
  height: 1024px;
...
export default LoggingWorkoutList;
