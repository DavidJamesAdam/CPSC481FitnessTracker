...
import WorkoutContainer1 from "../components/WorkoutContainer1";
...
`;
const WorkoutScreenDeleteWorkouRoot = styled.div`
  position: relative;
  background-color: var(--white);
  width: 100%;
  height: 1024px;
...
const WorkoutScreenDeleteWorkou = () => {
...
export default WorkoutScreenDeleteWorkou;
