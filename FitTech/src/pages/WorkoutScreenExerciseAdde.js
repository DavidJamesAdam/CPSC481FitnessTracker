...
import NewWorkout1 from "../components/NewWorkout1";
...
`;
const WorkoutScreenExerciseAddeRoot = styled.div`
  position: relative;
  background-color: var(--white);
  width: 100%;
  height: 1024px;
...
const WorkoutScreenExerciseAdde = () => {
...
export default WorkoutScreenExerciseAdde;
